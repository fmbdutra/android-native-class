...
//        listaMarcaCarro.add("GM");
        ...
        //populando a lista pelo banco de dados.
        listaMarcaCarro.addAll(bancoDados.buscaMarcas());
    ...
    public void listagem(View view) {
        ...
        ArrayList<Carro> listaCarroDoBancoDados = bancoDados.buscaCarros();

        bundle.putSerializable("lista",listaCarroDoBancoDados);
